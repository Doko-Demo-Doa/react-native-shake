...
Configures how much force is required to trigger a shake event. _Android only_ — has no effect on iOS, which relies on the system's built-in shake gesture.
